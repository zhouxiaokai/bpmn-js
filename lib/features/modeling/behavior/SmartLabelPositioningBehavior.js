 ...
 */
function SmartLabelPositioningBehavior(eventBus, modeling, bpmnFactory) {
...
inherits(SmartLabelPositioningBehavior, CommandInterceptor);

SmartLabelPositioningBehavior.$inject = [ 'eventBus', 'modeling', 'bpmnFactory' ];

module.exports = SmartLabelPositioningBehavior;
...
function getOptimalPosition(element) {
  ...
  var takenAlignments = connections.map(function(c) {

    var firstWaypoint = c.waypoints[1];

    return getApproximateOrientation(elementMid, firstWaypoint);
  });
  ...
  console.log(labelOrientation, freeAlignments);
